...
config :may_is_bike_month,
  ecto_repos: [MayIsBikeMonth.Repo]

# Configures the endpoint
config :may_is_bike_month, MayIsBikeMonthWeb.Endpoint,
  url: [host: "localhost"],
  render_errors: [
    formats: [html: MayIsBikeMonthWeb.ErrorHTML, json: MayIsBikeMonthWeb.ErrorJSON],
    layout: false
  ],
...
config :may_is_bike_month, MayIsBikeMonth.Mailer, adapter: Swoosh.Adapters.Local
